...
export const InfiniteMovingCases = ({
  ...
  items: ExperienceItem[]; // if showcase is work experiences
  // items: ProjectInfo[];  // if showcase is pProjects
                ...
                <div className="relative z-20 mt-1 flex flex-row items-center gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xl font-bold leading-[1.6] text-white">
                      {item.company}
                      {/* // if showcase is work experiences */}
                      {/* {item.project}  // if showcase is projects */}
                      <br />
                    </p>
                    {/* change text color */}
                    <p className="font-normal lg:text-base md:text-base text-base line-clamp-1">
                      {item.title}
                    </p>
                    ...
                    >
                      {item.responsibility}{" "}
                      {/* // if showcase is work experiences */}
                      {/*{item.description}   // if showcase is projects */}
                    </p>
